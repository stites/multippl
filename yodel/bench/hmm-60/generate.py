...
def finite_sequence60(num_sequences):
...
def pyro_data(args):
    ...
    states, seqs, _, seq_lens = finite_sequence60(args.num_sequences)
...
def yodel_data(args):
    ...
    states, _, iseqs, seq_lens = finite_sequence60(args.num_sequences)
