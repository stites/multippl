...
if __name__ == "__main__":
    ...
    print("  L1 transitions: {:.3f}".format((posterior_marg_probs_x - transitions).abs().sum().item()))
    print()
    ...
    print(emissions[:-1, :])
    print("  L1 emissions: {:.3f}".format((posterior_marg_probs_y - emissions).abs().sum().item()))
    print()
