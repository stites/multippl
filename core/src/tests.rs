...
fn program02() {
    ...
    check_exact("p02/y  ", 3.0 / 12.0, &mk02(b!("y")));
    check_exact("p02/x  ", 4.0 / 12.0, &mk02(b!("x")));
    check_exact("p02/x|y", 6.0 / 12.0, &mk02(b!("x" || "y")));
    check_exact("p02/x&y", 1.0 / 12.0, &mk02(b!("x" && "y")));
}
...
fn program03() {
    ...
    check_exact("p03/y  ", 3.0 / 6.0, &mk03(b!("y")));
    check_exact("p03/x  ", 4.0 / 6.0, &mk03(b!("x")));
    check_exact("p03/x|y", 6.0 / 6.0, &mk03(b!("x" || "y")));
